...
{
    /// <summary>
    /// Interaction logic for Lane1OutfConfig.xaml
    /// </summary>
    public partial class Lane1OutfConfig : UserControl
    {
        public Lane1OutfConfig()
        {
            InitializeComponent();
            InitComboBoxes();
        ...
        private void InitComboBoxes()
        {
            ...
            string stacktype = (string)globalVariables.Configvariables["sOutfeedTypeL1"];
        ...
        private void cb_OutfSection_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            if (comboBox != null && comboBox.SelectedItem != null)
            {
                ...
                globalVariables.Configvariables[$"sLane1OutfSec{index}Type"] = selectedItem;
            }
        }
        ...
        {
            if ((int)globalVariables.Configvariables["iAmountOutfLanes"] > 1 || (int)globalVariables.Configvariables["iLane2OutfSections"] > 1)
            {
                NavigationService nav = NavigationService.GetNavigationService(this);
                nav.Navigate(new Uri("Views\\Lane2OutfConfig.xaml", UriKind.RelativeOrAbsolute));
                nav.RemoveBackEntry();
            }
            else
            {
